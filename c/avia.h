...
#define G_NA 218.8 //239.13  mS/cm2 all conductances were divided by 0.000096 cm2
#define G_K3   8.225 // 10.22469
#define G_K1   0.769 // 1.1058
#define G_L   0.1915 // 0.2224
#define G_SYN   1*0.0214844 // single synapse value is 0.02391 mS/cm2*/ 
#define G_SYN2  0.09115 //0.10145   0.10145 equal to 7 nS ChR*/ 
#define G_SYN3   35*0.0214844 // autapse single synapse value
#define DELAY 3.0
